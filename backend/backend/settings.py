...
SECRET_KEY = 'django-insecure-p!j$dbl^g87h20+428smu37z_5em@mag*u#3j-4z*5hl^&+8=#'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'defaultdb', 
        'USER': 'avnadmin',  
        'PASSWORD': 'AVNS_4ODKt82gAWedBzPI6Bo',  
        'HOST': 'pg-38506ddc-italianomariano198-edb1.e.aivencloud.com',  
        'PORT': '28983',  # Puerto
        'OPTIONS': {
